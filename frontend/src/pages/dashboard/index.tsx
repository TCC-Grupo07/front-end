...
// import ProductChart from "../../components/ui/Grafic/ProductChart"
...
//             return product.quantidade > quantidadeMin && product.quantidade <= quantidadeMin + 20; // Produtos com quantidade entre min e min+20
//         });

//         const critical = products.filter(product => {
//             const quantidadeMin = parseInt(product.quantidadeMin, 10);
//             return product.quantidade <= quantidadeMin; // Produtos com quantidade crítica
//         });
...
import { Header } from "../../components/Header";
import styles from './styles.module.scss';
import ProductChart from "../../components/ui/Grafic/ProductChart"; // Importação correta
